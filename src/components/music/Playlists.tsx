    ...
    <div className="space-y-4">
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogTrigger asChild>
          <Button className="w-full border-2 border-black bg-black text-white shadow-[4px_4px_0px_0px_rgba(150,150,150,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all rounded-lg font-bold">
      ...
      {playlists.length === 0 ? (
        <div className="rounded-xl border-4 border-dashed border-black p-12 text-center bg-white">
          <p className="text-black font-medium">No playlists yet. Create your first playlist!</p>
        </div>
      ) : (
        <div className="space-y-2">
          {playlists.map((playlist) => {
            ...
            return (
              ...
              >
                <div className="rounded-lg border-2 border-black bg-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
